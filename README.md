...
- Создайте проект;
- Затем в `API Lidrary` найдите `YouTube Data API v3` и включите его для своего проекта;
...
### На свервере нет достпуа к Telegram API

Изменить страну для хостинга или использовать VPN